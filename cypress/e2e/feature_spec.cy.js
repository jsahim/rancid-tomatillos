describe('Feature single movie page', () => {
  ...
  it('should display an error message when the single movie was unable to be retrieved', () => {
    cy.visit('http://localhost:3000/')
      .get('.card')
      .first()
      .click()
      ...
      .get('h3')
      .should('text', 'We were unable to retreive your movie. Please return home and make a new selection.');
  });
});